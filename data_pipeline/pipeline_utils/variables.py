...
SQL_QUERY_MOVIE_IDS_MAX_YEAR = "SELECT id, year FROM movies WHERE year = (SELECT MAX(year) FROM movies);"
SQL_QUERY_MOVIES_TABLE = "SELECT * FROM movies"
SQL_QUERY_MOVIES_TABLE_MAX_YEAR = "SELECT * FROM movies WHERE year = (SELECT MAX(year) FROM movies);"
